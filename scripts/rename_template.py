...
It renames all the occurrences of soomin (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the soomin folder
        os.rename(
            os.path.join(root_dir_path, "exts", "soomin", "soomin"),
            os.path.join(root_dir_path, "exts", "soomin", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "soomin"), os.path.join(root_dir_path, "exts", new_name))
